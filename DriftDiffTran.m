...
elseif strcmp(Simulation,'GaussianTwoCarRCNew')
    eval('SetGaussian2CarParasRCOnlyNew');
elseif strcmp(Simulation,'GaussianTwoCarRCNewExponent')
    eval('SetGaussian2CarParasRCOnlyNewExponent');
end


%%%When the disturbance is turned off it causes the graph of all the
%%%variable to be more steep 
